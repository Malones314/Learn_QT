...
//          this,   //父窗口
//          "打开文件",   //标题 QString
//          "E:/MyCandCPPSpace/QtCode/charpter_14/charpter_14_QDialog", //对话框打开时默认路径  QString
//          "*.cpp *.h" //文件类型 过滤条件 QString
//          );

    QFileDialog* fileDialog = new QFileDialog( this, "测试", "E:/MyCandCPPSpace/QtCode/charpter_14/charpter_14_QDialog", "*.h");
    fileDialog->setFileMode( QFileDialog::AnyFile); //设置可选类型
      //AnyFile 可选任意文件
      //ExistingFile  只能选已存在的文件
      //Directory 只能选择目录
      //ExistingFiles 可选择多个已存在的文件
      //DirectoryOnly 只能选择目录，并且只显示目录
    fileDialog->show();
