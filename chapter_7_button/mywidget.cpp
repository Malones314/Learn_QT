...
MyWidget::MyWidget( QWidget* parent) : QWidget( parent) {
    //定义了 MyWidget 类的构造函数，它是 QWidget 类的子类。
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //button1->show();  //按顶层的方式展示

  button1->setParent( this);  //显示在当前窗口，设置父窗口
  button1->setText("hello");
  button1->resize( 200, 50);

  QPushButton* button2 = new QPushButton(QObject::tr("hello!"), this);
  button2->move( 400, 0); //移动位置

  //this->resize( 600, 400);  //设置窗口尺寸

  this->setFixedSize( 600, 400);  //设置固定窗口尺寸

  this->setWindowTitle("hello button");
